...
from broomworm.candidates import CANDIDATES, CandidateSpec, Trainable, WormBrain, build_candidate
from broomworm.cli import main
from broomworm.learning import TrainConfig, fitness_of, train_candidate
...
def test_seed_summary_aggregates_over_directories(tmp_path: Path) -> None:
    ...
    from broomworm.learning import BenchmarkConfig, run_benchmark, save_result
    from broomworm.learning.summary import collect, main, summary_table
