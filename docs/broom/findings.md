...
> This is the **broom** track. What we learned here that holds whatever the
> task is lives in `docs/knowledge/`, and the sibling track (the Doom player,
> `docs/doom/`) draws on the same file. Cross-track lessons are not
