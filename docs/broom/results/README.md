...
The map these feed is `docs/broom/findings.md` (one row per axis of Plan §20.7).
...
Brains: `docs/broom/brains/a1/` (stages 4-15), `docs/broom/brains/a2/` (bake-off, seeds 0-2),
`docs/broom/brains/car/` (retrained on the car preset, seeds 0-2). The dense (free)
