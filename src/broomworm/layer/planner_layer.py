...
from broomworm.body import Drive
from broomworm.candidates.base import Wheels
from broomworm.environments.sensors import SensorConfig
...
from broomworm.layer.path import nearest_unswept, next_waypoint, path_to
...
class PlannerLayer:
    ...
    def act(self, channels: Mapping[str, float]) -> Wheels | Drive:
        ...
        and the loop turns both into an intent (stage 24, ``broomworm.body``).
        """
