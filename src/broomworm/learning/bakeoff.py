...
network from scratch are trained by exactly the same code.
    ...
    broomworm evolve --candidate worm --layer needs --out runs/a2/worm.json
"""
...
from broomworm.candidates.base import Trainable
from broomworm.candidates.registry import CandidateSpec, build_candidate
from broomworm.environments.sensors import PRESETS
from broomworm.episode import BrainLike
from broomworm.layer.planner_layer import PlannerLayer
from broomworm.learning.benchmark import BenchmarkConfig, run_benchmark
from broomworm.learning.evolution import EvolutionConfig, EvolutionResult, GenerationStats, evolve
