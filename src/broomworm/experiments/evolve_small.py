...
Run: ``uv run broomworm train`` or ``python -m broomworm.experiments.evolve_small``
"""
...
from broomworm.brain import Network, save_brain
from broomworm.environments.simple_2d import AgentState, Obstacle, World
from broomworm.experiments import food_agent, obstacle_agent
...
def add_train_args(parser: argparse.ArgumentParser) -> None:
    """CLI options shared by ``broomworm train`` and the module entry point."""
