...
Run: ``uv run broomworm compare`` or ``python -m broomworm.experiments.compare_topologies``
"""
...
from broomworm.connectome import VARIANTS, Connectome, load_cook2019, make_variant
...
from broomworm.learning import EvolutionConfig, RewardTracker
...
def run_compare(args: argparse.Namespace) -> int:
    """Entry point for ``broomworm compare``."""
    if args.summarise:
