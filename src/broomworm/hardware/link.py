...
or a socketpair to :class:`~broomworm.hardware.fake_robot.FakeRobot`).
...
A reading is :class:`~broomworm.hardware.calibration.RawReading` as JSON, in
...
from wormlab.environments.sensors import PRESETS, SensorConfig, SensorSuite
...
class SimLink:
    ...
    def reset(self) -> dict[str, float]:
        """Same warm start as :func:`wormlab.episode.run_brain_episode`."""
