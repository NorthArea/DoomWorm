...
:class:`~broomworm.environments.sensors.SensorSuite` emits, in the same order.
...
from broomworm.environments.sensors import PASSTHROUGH, PRESETS, VACUUM, SensorConfig
