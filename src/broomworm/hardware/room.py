...
from wormlab.environments.simple_2d import AgentState, Dock, Obstacle, Wall, World

BATTERY_DRAIN = 0.002  # same as wormlab.environments.worlds (imported there, not here: no cycle)
