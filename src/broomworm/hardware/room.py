...
from broomworm.environments.simple_2d import AgentState, Dock, Obstacle, Wall, World

BATTERY_DRAIN = 0.002  # same as broomworm.environments.worlds (imported there, not here: no cycle)
