...
training harness, the benchmark and the layer stay untouched.
    ...
    broomworm evolve --candidate hybrid --init-brain docs/brains/a2/worm.json
...
from broomworm.candidates.base import Trainable, Wheels
...
class HybridBrain:
    ...
    def from_file(cls, path: Path | str, **overrides: Any) -> HybridBrain:
        ...
        from broomworm.candidates.registry import load_candidate
