...
from broomworm.adapters import FireAdapter, SensoryAdapter
from broomworm.brain import Network, Simulator, load_brain, save_brain
from broomworm.candidates.base import Wheels
from broomworm.episode import MotorLike, average_activity
...
class WormBrain:
    ...
    def from_scenario(cls, scenario: Any, name: str = "worm") -> WormBrain:
        """Wrap a :class:`~broomworm.experiments.worm_agent.WormScenario`."""
        return cls(
            scenario.template,
            scenario.sensory,
            scenario.motor,
