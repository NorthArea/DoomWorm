...
Run: ``uv run python -m doomworm.experiments.reward_demo [--steps N]``
"""
...
from doomworm.brain import Network, Neuron, Simulator
from doomworm.experiments import food_agent, obstacle_agent
from doomworm.experiments.episode import Record, run_episode
