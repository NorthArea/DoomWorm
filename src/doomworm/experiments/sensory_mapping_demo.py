...
Run: ``uv run python -m doomworm.experiments.sensory_mapping_demo [--top N]``
"""
...
from doomworm.connectome import build_network, default_sensory_mapping, load_cook2019
