...
from doomworm.candidates.base import Trainable, Wheels
from doomworm.candidates.rnn import RNNBrain

if TYPE_CHECKING:
    from doomworm.candidates.registry import TrainableBrain
...
class HybridBrain:
    ...
    def from_file(cls, path: Path | str, **overrides: Any) -> HybridBrain:
        ...
        from doomworm.candidates.registry import load_candidate
