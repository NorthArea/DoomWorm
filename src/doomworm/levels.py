...
The exit is a :class:`~wormlab.environments.simple_2d.Target` that ends the
...
from wormlab.environments.simple_2d import AgentState, Obstacle, Target, Wall, World
