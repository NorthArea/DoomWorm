...
from wormlab.adapters import FireAdapter, SensoryAdapter
from wormlab.brain import Network, Simulator, load_brain, save_brain
from wormlab.candidates.base import Wheels
from wormlab.episode import MotorLike, average_activity
...
class WormBrain:
    ...
    def from_scenario(cls, scenario: Any, name: str = "worm") -> WormBrain:
        """Wrap a :class:`~wormlab.experiments.worm_agent.WormScenario`."""
        return cls(
            scenario.template,
            scenario.sensory,
            scenario.motor,
