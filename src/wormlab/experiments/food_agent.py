...
Run: ``uv run python -m wormlab.experiments.food_agent [--steps N] [--plot]``
"""
...
from wormlab.experiments.obstacle_agent import MOTOR_NEURONS, build_brain, sensor_channels
...
def build_scenario() -> tuple[World, Simulator, SensoryAdapter, MotorAdapter]:
    """Everything needed for :func:`wormlab.experiments.episode.run_episode`."""
