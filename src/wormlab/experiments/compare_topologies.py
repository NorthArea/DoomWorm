...
Run: ``uv run doomworm compare`` or ``python -m wormlab.experiments.compare_topologies``
"""
...
from wormlab.connectome import VARIANTS, Connectome, load_cook2019, make_variant
from wormlab.episode import run_episode
from wormlab.experiments.evolve_worm import train_worm
from wormlab.experiments.worm_agent import WormScenario, summarise
from wormlab.learning import EvolutionConfig, RewardTracker
