...
Run: ``uv run python -m wormlab.experiments.worm_agent [--seed N] [--plot] [--gif]``
"""
...
from doomworm.levels import LEVELS, is_doom_level
from wormlab.adapters import FireAdapter, GroupMotorAdapter, SensoryAdapter
from wormlab.brain import Network, Simulator
...
from wormlab.visualization import save_debug_gif
