...
from wormlab.environments.sensors import PASSTHROUGH, PRESETS, SensorSuite
from wormlab.environments.simple_2d import Observation, World
...
class DoomwormEnv(gym.Env[np.ndarray, np.ndarray]):
    ...
    def render(self) -> str:
        """ASCII snapshot."""
        from wormlab.episode import Record
        from wormlab.experiments.episode import render_ascii
